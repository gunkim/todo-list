...
public class AsyncLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public AsyncLoginFilter(String defaultFilterProcessesUrl, ObjectMapper objectMapper,
        AuthenticationSuccessHandler successHandler, AuthenticationFailureHandler failHandler) {
